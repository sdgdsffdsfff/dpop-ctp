...
public interface BeidouTaskMapper extends GenericMapper<BeidouTask, Long> {

    // SELECT--------------------------------------------------------

    /**
     * 根据group_id获取所有的北斗task
     * 
     * @param groupId
     *            需要获取的group_id;
     * @return 获取到的任务列表
     */
    public List<BeidouTask> selectBeidouTasksByGroup(
     ...
     * @return 成功插入的条目数
     */
    public int batchInsertTasks(@Param("tasks") List<BeidouTask> tasks);
