...
package com.baidu.dpop.ctp.adtag.dao.mapper;
...
public interface AdTagMapper extends GenericMapper<AdTag, Long> {
     ...
     * 根据refId获取某个标注结果
     * 
     * @param vo 获取条件，包含refId与dataType
     * @return 获取到的结果
     */
     ...
     */
    public Set<Long> selectTestedAdTagByRefId(@Param("list") List<Long> list, @Param("dataType") Byte dataType);
