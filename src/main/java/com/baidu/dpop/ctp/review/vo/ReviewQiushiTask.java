...
public class ReviewQiushiTask implements DownloadInfo {

    private QiushiTask task;
    private ReviewAdTask rtask;

    public ReviewQiushiTask(GeneralTask gt, ReviewAdTask rtask) {
        Assert.isTrue(gt instanceof QiushiTask);
        this.setTask((QiushiTask) gt);
        this.setRtask(rtask);
    }

    public QiushiTask getTask() {
        return task;
    }

    public void setTask(QiushiTask task) {
        this.task = task;
    }
